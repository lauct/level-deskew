...
#system ("echo $url | head -n 300 > flickr.temp.htm");

open(OUT, ">tmpout.html") || die "$!";
print OUT '<div class="flickr-frame"><img src="'.$imgurl.'"><p><a href="'.$url.'">'.$title.'</a></p></div>';
close OUT;

#system ("open tmpout.html");
#system ("rm tmpout.html");
